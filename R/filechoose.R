...
#' named vector of absolute filepaths.
#' 
...
#' 
fileGetterFile <- function(roots, restrictions, filetypes, hidden=FALSE,session,id,dtoken) {
...
#'                    \code{roots = c('wd' = '.', 'home', '/home')} then \code{defaultRoot}                 !!!!!! A tester !!!!!!!!!!
...
#     shinyDropFileChoose(input, 'files', roots=c(wd='.'), filetypes=c('', 'txt'),
...
#' @export
#' 
parseDropFilePaths <- function(roots, selection) {
